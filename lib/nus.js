...
module.exports = function (opts) {
  ...
  self.opts = opts || {};
  self.opts.url = process.env.URL || self.opts.url || 'localhost'
  self.opts.port = process.env.PORT || self.opts.port || 3000;
  self.opts.redisUrl = process.env.REDIS_URL || self.opts.redisUrl || 'localhost';
